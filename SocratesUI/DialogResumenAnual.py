...
# Form implementation generated from reading ui file 'DialogResumenAnual.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Resumen Anual", None))
        ...
        self.label_5.setText(_translate("Dialog", "Resumen anual", None))
