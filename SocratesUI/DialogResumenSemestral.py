...
# Form implementation generated from reading ui file 'DialogResumenSemestral.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Resumen Semestral", None))
        ...
        self.label_5.setText(_translate("Dialog", "Resumen semestral", None))
